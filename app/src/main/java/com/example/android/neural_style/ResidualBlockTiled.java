...
/*
    Two-dimensional Residual Block layer.
    Each Residual Block consists of 2 tiled Convolution layers and two BatchNormalization layers.
...
*/
public class ResidualBlockTiled extends NeuralNetLayerBase {
    ...
    private int ksize = 3;
    private Convolution2DTiled c1;
    private Convolution2DTiled c2;
